...
export function WhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      {/* Main Button */}
      <div className="relative flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-xl hover:scale-110 hover:bg-[#20bd5a] transition-all duration-300">
