...
export default function InquiryForm({
  ...
  const fieldClass =
    'w-full px-5 py-3.5 bg-white border border-gray-200 rounded-full text-text-dark placeholder:text-gray-400 text-sm focus:outline-none focus:border-brand-gold focus:ring-2 focus:ring-brand-gold/20 transition-all';
    ...
    >
      ...
      <div className="flex items-stretch bg-white border border-gray-200 rounded-full overflow-hidden focus-within:border-brand-gold focus-within:ring-2 focus-within:ring-brand-gold/20 transition-all">
        <select
          ...
          className="bg-transparent px-4 py-3.5 text-sm text-text-dark border-e border-gray-200 focus:outline-none cursor-pointer"
        ...
        <input
          ...
          maxLength={30}
          className="flex-1 px-4 py-3.5 bg-transparent text-sm text-text-dark placeholder:text-gray-400 focus:outline-none"
        />
      </div>
      ...
      <textarea
        ...
        maxLength={2000}
        rows={3}
        className="w-full px-5 py-3.5 bg-white border border-gray-200 rounded-2xl text-text-dark placeholder:text-gray-400 text-sm focus:outline-none focus:border-brand-gold focus:ring-2 focus:ring-brand-gold/20 transition-all resize-none"
      />
