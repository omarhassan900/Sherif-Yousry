              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-white/5 text-text-secondary">
                    ...
                    <th className="text-left px-5 py-3 font-medium">Title (EN)</th>
                    <th className="text-left px-5 py-3 font-medium">Title (AR)</th>
                      ...
                      <tr key={item.id} className="border-b border-white/5 last:border-b-0 hover:bg-white/5 transition-colors">
                        ...
                        <td className="px-5 py-3">
                          <Link href={`/admin/services/${item.id}/edit`}
                            className="text-text-primary font-medium hover:text-brand-gold transition-colors truncate block max-w-[220px]">
                            {item.titleEn || '(Untitled)'}
                          </Link>
                        </td>
                        <td className="px-5 py-3 text-text-secondary truncate max-w-[180px]" dir="rtl">
                          {item.titleAr}
                        </td>
                        <td className="px-5 py-3">
                        ...
                        <td className="px-5 py-3">
                          <Link href={`/admin/services/${item.id}/edit`}
                            className="p-1.5 text-text-muted hover:text-brand-gold rounded transition-colors inline-flex" title="Edit">
