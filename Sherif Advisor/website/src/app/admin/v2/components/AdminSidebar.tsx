...
const NAV_ITEMS: NavItem[] = [
  { label: 'Dashboard', href: '/admin/v2', icon: LayoutDashboard },
  { label: 'Services', href: '/admin/v2/services', icon: Briefcase },
  { label: 'Articles', href: '/admin/v2/articles', icon: FileText },
  { label: 'Page Sections', href: '/admin/v2/sections', icon: Layers },
  { label: 'Inquiries', href: '/admin/v2/inquiries', icon: Inbox },
  { label: 'Media', href: '/admin/v2/media', icon: Image },
  { label: 'Administrators', href: '/admin/v2/administrators', icon: Users },
];
...
/**
 * AdminSidebar (v2) — Reusable sidebar navigation component for the v2 admin portal.
 *
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center px-6 py-5 border-b border-white/10">
        <h2 className="font-cormorant text-lg text-text-primary">
          Admin Portal <span className="text-brand-gold text-sm">v2</span>
        </h2>
      </div>
