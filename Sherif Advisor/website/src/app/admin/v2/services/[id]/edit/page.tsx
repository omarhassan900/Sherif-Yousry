  ...
  useEffect(() => {
    async function fetchService() {
      try {
        ...
        setDescriptionAr(data.metadata?.descriptionAr || data.bodyAr || '');
        setDescriptionEn(data.metadata?.descriptionEn || data.bodyEn || '');
